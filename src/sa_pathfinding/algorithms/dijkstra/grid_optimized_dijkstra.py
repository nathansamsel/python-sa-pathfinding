...
"""grid_optimized_dijkstra Module

This module contains the implementation for the Dijkstra search algorithm, optimized for grids.
...
Example:
    ...
    GridOptimizedDijkstra object. The result is a string representation of the
    path that was found - a comma separated list of state __repr__() calls::

        $ python grid_optimized_dijkstra.py OctileGrid('path/to/file')
        $ python grid_optimized_dijkstra.py OctileGrid('path/to/file') start=GridState(43, 65)
        $ python grid_optimized_dijkstra.py OctileGrid('path/to/file') goal=GridState(43, 65)
        $ python grid_optimized_dijkstra.py OctileGrid('path/to/file') start=GridState(43, 65) goal=GridState(132, 94)
        $ python grid_optimized_dijkstra.py OctileGrid('path/to/file') start=GridState(43, 65) goal=GridState(132, 94) heuristic=OctileGridHeuristic
...
class GridOptimizedDijkstra(GridOptimizedAstar):
    """ This class implements the Dijkstra search algorithm, optimized for grids.

    GridOptimizedDijkstra inherits from GridOptimizedAstar. See GridOptimizedAstar for
    ...
    def __init__(self,
                 ...
                 goal: State = None,
                 verbose: bool = False):
        """GridOptimizedDijkstra __init__ method.
